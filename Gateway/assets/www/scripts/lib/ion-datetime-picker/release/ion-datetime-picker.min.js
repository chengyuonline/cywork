    ...
    angular.module("ion-datetime-picker", ["ionic"]).directive("ionDatetimePicker", function () {
        return {
            ...
            controller: ["$scope", "$ionicPopup", "$ionicPickerI18n", "$timeout", function (e, t, n, i) {
                function o(e, t) {
                    t = t || 0, 0 !== t && e.setDate(e.getDate() + t), d.year = e.getFullYear(), d.month = e.getMonth(), d.day = e.getDate(), d.hour = e.getHours(), d.minute = e.getMinutes(), d.second = e.getSeconds(), d.date = e
                }
                ...
                e.changeBy = function (t, n) {
                    ...
                    var i = new Date(e.year, e.month, t), a = !0;
                    if (e.onlyValid.after) {
                        ...
                        var r = l(e.onlyValid.between.initial), u = l(e.onlyValid.between["final"]);
                        e.onlyValid.inclusive ? (a = i >= r && u >= i, !a && n && (r > i && o(r, 0), i > u && o(u, 0))) : (a = i > r && u > i, !a && n && (r >= i && o(r, 1), i >= u && o(u, -1)))
                    } else if (e.onlyValid.outside) {
                        var r = l(e.onlyValid.outside.initial), u = l(e.onlyValid.outside["final"]);
