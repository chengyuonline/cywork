define(['app'], function (app) {
    'use strcit';
    app.controller('rShuikuCtrl',function ($scope,$http,$ionicScrollDelegate) {
        $http({
            method:'POST',
            url:_HTTP_ADDRESS + 'portal_support/appData/resData.do',
            headers: {
        ...
        // ];
        //控制滚动
        $scope.w = Math.min(document.documentElement.clientWidth,window.innerWidth);
